This is a sample project to demonstrate how to use private repository or mirror repository in a golang project with [Gogradle](https://github.com/blindpirate/gogradle). 
